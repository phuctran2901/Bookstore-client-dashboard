                                ...
                                <div className="col-xl-6">
                                    <div className="row">
                                        <div className="form-group mb-3 col-xs-12 col-sm-6">
                                            ...
                                            />
                                            {errors.pages && <span style={{ color: 'red' }}>Vui lòng nhập số trang</span>}
                                        </div>
                                        <div className="form-group mb-3 col-xs-12 col-sm-6">
                                            <label
                                            >Năm xuất bản
                                            ...
                                            />
                                            {errors.publicYear && <span style={{ color: 'red' }}>Vui lòng nhập năm xuất bản</span>}
                                        </div>
                                        <div className="form-group mb-3 col-xs-12 col-sm-6">
                                            <label
                                            >Số lượng
                                        ...
                                        <div className="form-group mb-3 col-xs-12 col-sm-6">
                                            ...
                                            />
                                            {errors.price && <span style={{ color: 'red' }}>Vui lòng nhập giá sản phẩm</span>}
                                        </div>
                                    </div>
                                    <div className="form-group mb-3">
                                        <label
                                        >Giảm giá (không bắt buộc) (%)
                                        </label>
                                        <input
                                            id="sale"
                                            type="text"
